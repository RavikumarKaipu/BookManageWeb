...
const ForgotPassword = () => {
  ...
  const handleVerifyEmail = async () => {
    try {
      const response = await axios.post('https://bookmanage-backend.vercel.app/api/verify-email', { email });
  ...
  const handleUpdatePassword = async () => {
    ...
    try {
      const response = await axios.post('https://bookmanage-backend.vercel.app/api/update-password', {
        email,
        newPassword,
      });
